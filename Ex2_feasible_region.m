...
% sdpvar a b c
% const = [a <= -1; a >=-5];
% const = [const, b*c <= a, b>=0, b <= 10, c >= -10];
% 
% plot(const,[a,b,c],'r',100,opts);                  %% boundary points %
...
view(-110,20)
print(gcf,'Fig1','-painters','-depsc','-r600')
...
set(gcf,'Position',[250 150 300 300]);
set(gca,'TickLabelInterpreter','latex')
%print(gcf,'Fig2.eps','-painters','-depsc','-r 600')
print(gcf,'Fig2','-painters','-dpng','-r 600')
